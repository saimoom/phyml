...
public class NumSubCatGammaAverage extends JPanel implements ActionListener,
	...
	public NumSubCatGammaAverage() {
		...
		lab1 = new JLabel("# Subcategories");
		lab2 = new JLabel("Gamma");
		lab3 = new JLabel("Alpha");
		...
		add(new JPanel());
		layout.setDimensions(0.30, 0.8);
		JPanel p1 = new JPanel();
		add(p1);
		layout.setDimensions(0.01, 0.8);
		add(new JPanel());
		layout.setDimensions(0.43, 0.8);
		JPanel p2 = new JPanel();
		add(p2);
		layout.setDimensions(0.01, 0.8);
		add(new JPanel());
		layout.setDimensions(0.23, 0.8);
		...
		p2.setLayout(lO2);
		lO2.setDimensions(0.22, 1);
		p2.add(lab2);
		lO2.setDimensions(0.3, 1);
		p2.add(gammaBox);
		lO2.setDimensions(0.05, 1);
		p2.add(new JLabel());
		...
		p3.setLayout(lO3);
		lO3.setDimensions(0.05, 1);
		p3.add(new JPanel());
		lO3.setDimensions(0.45, 1);
		p3.add(lab4);
		lO3.setDimensions(0.5, 1);
		p3.add(average);
	}
